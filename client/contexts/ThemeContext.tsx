  ...
  features: [
    {
      title: "Live Preview",
      description:
        "See your color changes instantly across a complete product demo. Test colors in real components before committing.",
    },
    {
      title: "Smart Palettes",
      description:
        "Generate harmonious color schemes using complementary, triadic, and analogous color theory algorithms.",
    },
    {
      title: "Accessibility First",
      description:
        "Built-in WCAG contrast checker ensures your colors meet accessibility standards (AA & AAA).",
    },
    {
      title: "Easy Export",
      description:
        "Export as CSS variables, Tailwind config, or JSON. Copy to clipboard with one click.",
    },
    {
      title: "Custom Fonts",
      description:
        "Upload and preview custom fonts with your color system. Support for TTF, OTF, and WOFF formats.",
    },
    {
      title: "Dark Mode Ready",
      description:
        "Design for both light and dark modes simultaneously with automatic contrast adjustments.",
    },
  ],
  footerCategories: [
    {
...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  useEffect(() => {
    ...
    // Set font family
    const fontFamily = state.customFontName
      ? state.customFontName
      : FONT_FAMILIES[state.fontFamily as keyof typeof FONT_FAMILIES];
    ...
    setState((prev) => ({
      ...
      colors: {
        ...
        accent:
          colors.length > 2
            ? colors[2]
            : `${(baseHue + 45) % 360} ${saturation}% ${primaryLightness}%`,
        bg: bgLight,
        text: textLight,
      },
    }));
